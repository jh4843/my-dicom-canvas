...
export const vrDttm = ["DT", "TM"];
export const vr16bitVL = ["SS"];
...
export const pixelVR = ["PI"];
export const simpleNumber = ["NA"];

export const vrType = vr32bitVL
  .concat(vrDttm)
  .concat(vr16bitVL)
  .concat(charSetString)
  .concat(pixelVR)
  .concat(simpleNumber);
export type tVrType = (typeof vrType)[number];

export type tTagElementInfo = string[] | undefined;

export interface iTagElement {
  [key: string]: tTagElementInfo; // [0]: VR, [1]:Value Length(byte),
}

export interface iTagDictionary {
  [key: string]: iTagElement;
}
...
export const tagGroups: iTagGroup = {
  x0000: "Command",
  x0002: "Meta Element",
  x0004: "File Set",
  //'x0004': 'Directory',
...
export const tagDictionary: iTagDictionary = {
  "0x0000": {
